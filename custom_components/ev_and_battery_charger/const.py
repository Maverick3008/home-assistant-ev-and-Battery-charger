...
CONF_FULL_CHARGE_EXTRA_MINUTES = "full_charge_extra_minutes"
...
DEFAULT_FULL_CHARGE_EXTRA_MINUTES = 10
DEFAULT_CALENDAR_ENTITY = ""
DEFAULT_TARGET_SOURCE_PRIORITY = "calendar_first"

# Version 1.4.0 calendar automation defaults.
CALENDAR_AUTO_TARGET_SOC = 100.0
CALENDAR_RESET_TARGET_SOC = 80.0
CALENDAR_REFRESH_INTERVAL_MINUTES = 30
